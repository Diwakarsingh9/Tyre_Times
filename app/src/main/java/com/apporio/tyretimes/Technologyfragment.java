...
import com.apporio.tyretimes.adapter.Technologyadapter;
...
//                            parsingforphotos(getActivity(), s44);
    ...
    public static Technologyfragment newInstance(FragmentActivity activity,String position ) {
        Technologyfragment f = new Technologyfragment();
        Bundle b = new Bundle();
...
//            s44=s2;
//
                String locationurl2 = Api_s.pagefraglist.concat("Technology");
...
//
                        ...
                        Technologyfragment.pb.setVisibility(View.GONE);
                        Technologyfragment.lv.setVisibility(View.VISIBLE);
              ...
              lv.setAdapter(new Technologyadapter(activity, moduleet, modulesrc, moduletilte, moduledate,
                      moduledescp, moduleimg, image1, title1,modulesrc_link,video_key));
                            //adp.notifyDataSetChanged();


//                        Technologyfragment.lv.setFocusable(false);
                ...
                queue.add(sr2);
                   Technologyfragment.pb.setVisibility(View.VISIBLE);
            Technologyfragment.lv.setVisibility(View.GONE);
//
         }
//
//

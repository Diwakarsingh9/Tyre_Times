...
import com.apporio.tyretimes.adapter.Digiadapter;
 ...
 */
public class Digitrends extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_digitrends, null);
...
//                            parsingforphotos(getActivity(), s44);
    ...
    public static Digitrends newInstance(FragmentActivity activity,String position ) {
        Digitrends f = new Digitrends();
        Bundle b = new Bundle();
...
//            s44=s2;
//
                String locationurl2 = Api_s.pagefraglist.concat("Digital Trend");
...
//
                        ...
                        Digitrends.pb.setVisibility(View.GONE);
                        Digitrends.lv.setVisibility(View.VISIBLE);
                        ...
                        try {
                            ...
                            lv.setAdapter(new Digiadapter(activity,moduleet,modulesrc, moduletilte, moduledate,
                                    moduledescp, moduleimg,image1,title1, modulesrc_link,video_key));
                            //adp.notifyDataSetChanged();


                       Digitrends.lv.setFocusable(false);
                ...
                queue.add(sr2);
                   Digitrends.pb.setVisibility(View.VISIBLE);
            Digitrends.lv.setVisibility(View.GONE);

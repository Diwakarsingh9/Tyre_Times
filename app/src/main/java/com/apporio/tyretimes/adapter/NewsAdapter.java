...
import com.apporio.tyretimes.Mainfragment;
import com.apporio.tyretimes.Newsfragment;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(position==6) {
            ...
            if(position<6) {
                ...
                holder.descp.setText(Html.fromHtml(dscvp.get(position)));

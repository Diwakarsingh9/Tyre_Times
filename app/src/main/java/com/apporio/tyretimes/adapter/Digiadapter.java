...
import com.apporio.tyretimes.Digitrends;
 ...
 */
public class Digiadapter extends BaseAdapter {
...
//            R.drawable.bgg,R.drawable.flip1,R.drawable.reall2,R.drawable.flip2,R.drawable.flip3,};
    ...
    public Digiadapter(Context activity, ArrayList<String> stringArrayList, ArrayList<String> strings, ArrayList<String> moduletilte, ArrayList<String> moduledate, ArrayList<String> moduledescp, ArrayList<String> moduleimg, ArrayList<String> image1, ArrayList<String> title1, ArrayList<String> modulesrc_link, ArrayList<String> video_key) {
        ...
        final Holder holder;
                ...
                convertView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        in.putExtra("title", "Digital Trend");
                        ...
                        in.putExtra("plc", city2.get(pos));
                         in.putExtra("id", Digitrends.module_id.get(pos));

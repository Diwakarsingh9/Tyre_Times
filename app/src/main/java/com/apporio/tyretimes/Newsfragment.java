...
//            parsing(getActivity(), s1, pos);
            parsingforvideosgallery(getActivity(),s44);
...
//
                ...
                String locationurl2 = Api_s.pagefraglist.concat("Tyre");
...
//
    public static void parsingforvideosgallery(final Context activity,String s1) {



        String locationurl2 = Api_s.videosgaallery.concat("tyre");
...
////
                ...
                try {
                    ...
                    data_list11 = received2.innervideosgallery;
                    for (int i = 0; i < data_list11.size(); i++) {
                        gallery_id.add(data_list11.get(i).gallery_id);
                        category.add(data_list11.get(i).category);
                        image1.add(data_list11.get(i).them_image);
                        title1.add(data_list11.get(i).titless);
                        video_key.add(data_list11.get(i).video_key);
                        video_date.add(data_list11.get(i).video_date);
